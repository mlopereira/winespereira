...
<body>	
	...
	$consultaVenda = $pdo->query("SELECT * FROM vendas WHERE ticket='$ticket_compra'");
...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		...
		<?php $consultaProd = $pdo->query("SELECT produto FROM produtos WHERE id='$exibeVenda[id_prod]'");
